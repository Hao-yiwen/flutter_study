...
class GuessGamePage extends StatefulWidget {
  const GuessGamePage({Key? key, required this.titles}) : super(key: key);
...
class _MyHomePageState extends State<GuessGamePage> {
  ...
  void startGame() {
    numList = List.generate(16, (index) => candidates[index ~/ 2])..shuffle();
